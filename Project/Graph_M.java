...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Uttar North");
			g.addVertex("Uttara Center");
			g.addVertex("Uttara South");
			g.addVertex("Pallabi");
			g.addVertex("Mirpur 11");
			g.addVertex("Mirpur 10");
			g.addVertex("Kazipara");
			g.addVertex("Shewrapara");
			g.addVertex("Agargaon");
			g.addVertex("Bijoy Sarani");
			g.addVertex("Farmgate");
			g.addVertex("Karwan Bazar");
			g.addVertex("Shahbag");
			g.addVertex("Dhaka University");
			g.addVertex("Bangladesh Secretariat");
			g.addVertex("Motijheel");
			g.addVertex("Kakrail");
			g.addVertex("Airport");
			
			
			g.addEdge("Uttar North", "Uttara Center", 1);
			g.addEdge("Uttara Center", "Uttara South", 2);
			g.addEdge("Uttara South", "Pallabi", 4);
			g.addEdge("Pallabi", "Mirpur 11", 3);
			g.addEdge("Mirpur 11", "Mirpur 10", 3);
			g.addEdge("Mirpur 10", "Kazipara", 2);
			g.addEdge("Kazipara", "Shewrapara", 2);
			g.addEdge("Shewrapara", "Agargaon", 4);
			g.addEdge("Agargaon", "Bijoy Sarani", 3);
			g.addEdge("Bijoy Sarani", "Farmgate", 2);
			g.addEdge("Farmgate", "Karwan Bazar", 5);
			g.addEdge("Karwan Bazar", "Shahbag", 7);
			g.addEdge("Shahbag", "Dhaka University", 6);
			g.addEdge("Dhaka University", "Bangladesh Secretariat", 7);
			g.addEdge("Bangladesh Secretariat", "Motijheel", 4);


			g.addEdge("Uttara Center", "Airport", 7);
			g.addEdge("Airport", "Mirpur", 6);
			g.addEdge("Kakrail", "Bangladesh Secretariat", 4);
			g.addEdge("Kakrail", "Shahbag", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			while(true)
			{
                ...
                HashMap<String, Boolean> processed31 = new HashMap<>();
                if(!g.containsVertex(s3) || !g.containsVertex(s4) || !g.hasPath(s3, s4, processed31))
                    System.out.println("THE INPUTS ARE INVALID");
                else 
                {
                    ArrayList<String> str = g.get_Interchanges(g.Get_Minimum_Distance(s3, s4));
                    int len = str.size();
                    System.out.println("SOURCE STATION : " + s3);
                    System.out.println("SOURCE STATION : " + s4);
